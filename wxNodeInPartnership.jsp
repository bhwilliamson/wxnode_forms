		...
		<table border="0" cellpadding="0" cellspacing="5" width="100%">		
                	<tr>
                      	...
                      	<tr>                      	
                      		...
                      		<td><input class="datadisplay" size="50" id="class" name="class" type="text" tabindex="0" value="partners" readonly/></td>
                      	</tr>
                      	<tr>                      	
                      		<td class="controlname"><label for="providerid">Provider Id:</label></td>
                      		<td><input class="datadisplay" size="50" id="providerid" name="providerid" type="text" value="" /></td>
                      	</tr>
                      	<tr>                      	
