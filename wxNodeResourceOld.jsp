		...
		<table border="0" cellpadding="0" cellspacing="5" summary="wx node resource form" width="100%">		
                	<tr>
                      	...
                      	<tr>
                      		...
                      		<td><input class="datadisplay required" size="50" id="reference" name="reference" type="text"/></td>
                      	</tr>
                      	<tr>
                      		<td class="controlname"><label for="resources">Resources:</label></td>
                      		<td><input class="datadisplay required" size="50" id="resources" name="resources" type="text" value=""/></td>
                      	</tr>
                      	<tr>
