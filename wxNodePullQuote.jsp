		...
		<table border="0" cellpadding="0" cellspacing="5" width="100%">		
                	<tr>
                      	...
                      	<tr>                      	
                      		...
                      		<td><input class="datadisplay" size="50" id="class" name="class" type="text" tabindex="0" value="pullquote" readonly/></td>
                      	</tr>
                      	<tr>                      	
                      		<td class="controlname"><label for="quote">Quote:</label></td>
                      		<td><input class="datadisplay" size="50" id="quote" name="quote" type="text" value=""/></td>
                      	</tr>
                      	<tr>                      	
                      		<td class="controlname"><label for="source">Credit:</label></td>
                      		<td><input class="datadisplay" size="50" id="source" name="source" type="text" value="" /></td>
                      	</tr>
                      	<tr>                      	
